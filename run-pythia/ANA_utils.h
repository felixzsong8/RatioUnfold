...
class ANA_utils {
 ...
 public :
  ...
  void Get_BarePromptLepton(Pythia8::Event event, std::vector<int> vecboson_index, std::vector<TruthPart>* p_PromptBareLept_Coll, std::vector<TruthPart>* p_ConversionLept_Coll, std::vector<TruthPart>* p_PhotonFSR_Coll, std::vector<TruthPart>* p_Neutrino_Coll);
